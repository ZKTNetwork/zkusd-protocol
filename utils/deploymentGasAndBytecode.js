...
const ZKTStaking = artifacts.require("./ZKT/ZKTStaking.sol")
const ZKToken = artifacts.require("./ZKT/ZKToken.sol")
const LockupContractFactory = artifacts.require("./ZKT/LockupContractFactory.sol")
const CommunityIssuance = artifacts.require("./ZKT/CommunityIssuance.sol")
const HintHelpers = artifacts.require("./HintHelpers.sol")

const CommunityIssuanceTester = artifacts.require("./ZKT/CommunityIssuanceTester.sol")
...
async function main() {
  ...
  const ZKTContracts = await dh.deployZKTContractsHardhat(ARBITRARY_ADDRESS, ARBITRARY_ADDRESS)
  ...
  console.log(`\n`)
  console.log(`ZKT CONTRACTS`)
  await logContractDeploymentCosts(ZKTContracts)
  console.log(`\n`)
  logContractBytecodeLengths(ZKTContractABIs)
  console.log(`\n`)
