...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawZKUSD(...params) {
    return this.forwardFunction(params, 'withdrawZKUSD(uint256,uint256,address,address)')
  }

  async repayZKUSD(...params) {
    return this.forwardFunction(params, 'repayZKUSD(uint256,address,address)')
  }
  ...
  async ZKUSD_GAS_COMPENSATION(...params) {
    return this.proxyFunction('ZKUSD_GAS_COMPENSATION', params)
  }
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingZKUSDDebtReward(...params) {
    return this.proxyFunction('getPendingZKUSDDebtReward', params)
  }
  ...
  async L_ZKUSDDebt() {
    return this.proxyFunction('L_ZKUSDDebt', [])
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedZKUSDDeposit(user) {
    return this.proxyFunctionWithUser('getCompoundedZKUSDDeposit', user)
  }
...
class ZKTStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token)
  }
  ...
  async F_ZKUSD(user) {
    return this.proxyFunctionWithUser('F_ZKUSD', user)
  }
}
