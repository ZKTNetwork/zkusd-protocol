...
contract("Gas compensation tests", async (accounts) => {
  ...
  it("_getCollGasCompensation(): returns the 0.5% of collaterall if it is < $10 in value", async () => {
    ...
    /* 
    NEON:USD price = 1000000000 (1 billion)
    coll = 0.000000005 NEON (5e9 wei): $5 in value 
    -> Expect 0.5% of collaterall as gas compensation */
  ...
  it("_getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral < $10 in value", async () => {
    ...
    NEON:USD price = 200
    coll = 9.999 NEON  
    0.5% of coll = 0.04995 NEON. USD value: $9.99
    -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation_1 = (
    ...
    /* NEON:USD price = 200
     coll = 0.055 NEON  
     0.5% of coll = 0.000275 NEON. USD value: $0.055
     -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation_2 = (
    ...
    /* NEON:USD price = 200
    coll = 6.09232408808723580 NEON  
    0.5% of coll = 0.004995 NEON. USD value: $6.09
    -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation_3 = (
  ...
  it("getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral = $10 in value", async () => {
    ...
    NEON:USD price = 200
    coll = 10 NEON  
    0.5% of coll = 0.5 NEON. USD value: $10
    -> Expect 0.5% of collaterall as gas compensation */
  ...
  it("getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral = $10 in value", async () => {
    ...
    /* 
    NEON:USD price = 200 $/E
    coll = 100 NEON  
    0.5% of coll = 0.5 NEON. USD value: $100
    -> Expect $100 gas compensation, i.e. 0.5 NEON */
    const gasCompensation_1 = (
    ...
    NEON:USD price = 200 $/E
    coll = 10.001 NEON  
    0.5% of coll = 0.050005 NEON. USD value: $10.001
    -> Expect $100 gas compensation, i.e.  0.050005  NEON */
    const gasCompensation_2 = (
    ...
    NEON:USD price = 200 $/E
    coll = 37.5 NEON  
    0.5% of coll = 0.1875 NEON. USD value: $37.5
    -> Expect $37.5 gas compensation i.e.  0.1875  NEON */
    const gasCompensation_3 = (
    ...
    /* 
    NEON:USD price = 45323.54542 $/E
    coll = 94758.230582309850 NEON  
    0.5% of coll = 473.7911529 NEON. USD value: $21473894.84
    -> Expect $21473894.8385808 gas compensation, i.e.  473.7911529115490  NEON */
    ...
    /* 
    NEON:USD price = 1000000 $/E (1 million)
    coll = 300000000 NEON   (300 million)
    0.5% of coll = 1500000 NEON. USD value: $150000000000
    -> Expect $150000000000 gas compensation, i.e. 1500000 NEON */
  ...
  it("_getCompositeDebt(): returns (debt + 50) when collateral < $10 in value", async () => {
    ...
    debt = 10 ZKUSD
    0.5% of coll = 0.04995 NEON. USD value: $9.99
    -> Expect composite debt = 10 + 200  = 2100 ZKUSD*/
    ...
    /* NEON:USD price = 200
     ...
     debt = 0 ZKUSD
     0.5% of coll = 0.000275 NEON. USD value: $0.055
     -> Expect composite debt = 0 + 200 = 200 ZKUSD*/
    ...
    // debt = 200 ZKUSD
    // 0.5% of coll = 0.004995 NEON. USD value: $6.09
    // -> Expect  composite debt =  200 + 200 = 400  ZKUSD */
  ...
  // returns $10 worth of NEON when 0.5% of coll == $10
  it("getCompositeDebt(): returns (debt + 50) collateral = $10 in value", async () => {
    ...
    debt = 123.45 ZKUSD
    0.5% of coll = 0.5 NEON. USD value: $10
    -> Expect composite debt = (123.45 + 200) = 323.45 ZKUSD  */
  ...
  it("getCompositeDebt(): returns (debt + 50) when 0.5% of collateral > $10 in value", async () => {
    ...
    coll = 100 NEON  
    debt = 2000 ZKUSD
    -> Expect composite debt = (2000 + 200) = 2200 ZKUSD  */
    ...
    coll = 37.5 NEON  
    debt = 500 ZKUSD
    -> Expect composite debt = (500 + 200) = 700 ZKUSD  */
    ...
    NEON:USD price = 45323.54542 $/E
    coll = 94758.230582309850 NEON  
    debt = 1 billion ZKUSD
    -> Expect composite debt = (1000000000 + 200) = 1000000200 ZKUSD  */
    await priceFeed.setPrice("45323545420000000000000");
    const price_2 = await priceFeed.getPrice();
    ...
    NEON:USD price = 1000000 $/E (1 million)
    coll = 300000000 NEON   (300 million)
    debt = 54321.123456789 ZKUSD
   -> Expect composite debt = (54321.123456789 + 200) = 54521.123456789 ZKUSD */
    await priceFeed.setPrice(dec(1, 24));
    const price_3 = await priceFeed.getPrice();
  ...
  it("getCurrentICR(): Incorporates virtual debt, and returns the correct ICR for new troves", async () => {
    ...
    // B opens with 0.5 NEON, 50 ZKUSD
    ...
    // C opens with 2.5 NEON, 160 ZKUSD
    ...
    // E opens with 4405.45 NEON, 32598.35 ZKUSD
    await openTrove({
  ...
  it("Gas compensation from pool-offset liquidations. All collateral paid as compensation", async () => {
    ...
    await openTrove({
      ICR: toBN(dec(2, 18)),
      extraZKUSDAmount: B_totalDebt.add(C_totalDebt),
      extraParams: { from: erin },
    });

    // D, E each provide ZKUSD to SP
    ...
    const ZKUSDinSP_0 = await stabilityPool.getTotalZKUSDDeposits();
    ...
    // Check liquidator's balance increases by 0.5% of A's coll (1 NEON)
    ...
    // Check SP ZKUSD has decreased due to the liquidation
    const ZKUSDinSP_A = await stabilityPool.getTotalZKUSDDeposits();
    assert.isTrue(ZKUSDinSP_A.lte(ZKUSDinSP_0));

    // Check NEON in SP has received the liquidation
    const NEONinSP_A = await stabilityPool.getNEON();
    assert.equal(NEONinSP_A.toString(), aliceColl.sub(_0pt5percent_aliceColl)); // 1 NEON - 0.5%
    ...
    // Check liquidator's balance increases by B's 0.5% of coll, 2 NEON
    ...
    assert.equal(compensationReceived_B, _0pt5percent_bobColl); // 0.5% of 2 NEON

    // Check SP ZKUSD has decreased due to the liquidation of B
    const ZKUSDinSP_B = await stabilityPool.getTotalZKUSDDeposits();
    assert.isTrue(ZKUSDinSP_B.lt(ZKUSDinSP_A));

    // Check NEON in SP has received the liquidation
    const NEONinSP_B = await stabilityPool.getNEON();
    assert.equal(
      NEONinSP_B.toString(),
      aliceColl
    ...
    /* 
    NEON:USD price = 3.141592653589793238
    Carol coll = 3 NEON. Value = (3 * 3.141592653589793238) = $6
    -> Expect 0.5% of collaterall to be sent to liquidator, as gas compensation */
    ...
    // Check liquidator's balance increases by C's 0.5% of coll, 3 NEON
    ...
    // Check SP ZKUSD has decreased due to the liquidation of C
    const ZKUSDinSP_C = await stabilityPool.getTotalZKUSDDeposits();
    assert.isTrue(ZKUSDinSP_C.lt(ZKUSDinSP_B));

    // Check NEON in SP has not changed due to the lquidation of C
    const NEONinSP_C = await stabilityPool.getNEON();
    assert.equal(
      NEONinSP_C.toString(),
      aliceColl
        .sub(_0pt5percent_aliceColl)
  ...
  it("gas compensation from pool-offset liquidations: 0.5% collateral < $10 in value. Compensates $10 worth of collateral, liquidates the remainder", async () => {
    ...
    await openTrove({
      ICR: toBN(dec(60, 18)),
      extraZKUSDAmount: dec(600, 18),
      extraParams: { from: carol },
    });
    await openTrove({
      ICR: toBN(dec(80, 18)),
      extraZKUSDAmount: dec(1, 23),
      extraParams: { from: dennis },
    });
    await openTrove({
      ICR: toBN(dec(80, 18)),
    ...
    // D, E each provide 10000 ZKUSD to SP
    ...
    const ZKUSDinSP_0 = await stabilityPool.getTotalZKUSDDeposits();
    const NEONinSP_0 = await stabilityPool.getNEON();
    ...
    /* 
    NEON:USD price = 199.999
    Alice coll = 1 NEON. Value: $199.999
    0.5% of coll  = 0.05 NEON. Value: (0.05 * 199.999) = $9.99995
    Minimum comp = $10 = 0.05000025000125001 NEON.
    -> Expect 0.05000025000125001 NEON sent to liquidator, 
    and (1 - 0.05000025000125001) = 0.94999974999875 NEON remainder liquidated */
    ...
    // Check SP ZKUSD has decreased due to the liquidation of A
    const ZKUSDinSP_A = await stabilityPool.getTotalZKUSDDeposits();
    assert.isTrue(ZKUSDinSP_A.lt(ZKUSDinSP_0));

    // Check NEON in SP has increased by the remainder of B's coll
    const collRemainder_A = aliceColl.sub(_0pt5percent_aliceColl);
    const NEONinSP_A = await stabilityPool.getNEON();

    const SPNEONIncrease_A = NEONinSP_A.sub(NEONinSP_0);

    assert.isAtMost(th.getDifference(SPNEONIncrease_A, collRemainder_A), 1000);
    ...
    /* 
    NEON:USD price = 15
    Bob coll = 15 NEON. Value: $165
    0.5% of coll  = 0.75 NEON. Value: (0.75 * 11) = $8.25
    Minimum comp = $10 =  0.66666...NEON.
    -> Expect 0.666666666666666666 NEON sent to liquidator, 
    and (15 - 0.666666666666666666) NEON remainder liquidated */
    ...
    const SPNEONIncrease_B = NEONinSP_B.sub(NEONinSP_A);

    assert.isAtMost(th.getDifference(SPNEONIncrease_B, collRemainder_B), 1000);
  });
  ...
  it("gas compensation from pool-offset liquidations: 0.5% collateral > $10 in value. Compensates 0.5% of  collateral, liquidates the remainder", async () => {
    ...
    /* 
    NEON:USD price = 200
    Alice coll = 10.001 NEON. Value: $2000.2
    0.5% of coll  = 0.050005 NEON. Value: (0.050005 * 200) = $10.01
    Minimum comp = $10 = 0.05 NEON.
    -> Expect  0.050005 NEON sent to liquidator, 
    and (10.001 - 0.050005) NEON remainder liquidated */
    ...
    // Check NEON in SP has increased by the remainder of A's coll
    const collRemainder_A = aliceColl.sub(_0pt5percent_aliceColl);
    const NEONinSP_A = await stabilityPool.getNEON();
    ...
    /* 
   NEON:USD price = 200
   Bob coll = 37.5 NEON. Value: $7500
   0.5% of coll  = 0.1875 NEON. Value: (0.1875 * 200) = $37.5
   Minimum comp = $10 = 0.05 NEON.
   -> Expect 0.1875 NEON sent to liquidator, 
   and (37.5 - 0.1875 NEON) NEON remainder liquidated */
  ...
  it("liquidateTroves(): full offset.  Compensates the correct amount, and liquidates the remainder", async () => {
    ...
    */
    ...
    // Check ZKUSD in SP has decreased
    const ZKUSDinSP_1 = await stabilityPool.getTotalZKUSDDeposits();
    assert.isTrue(ZKUSDinSP_1.lt(ZKUSDinSP_0));
    ...
    // Check NEON in stability pool now equals the expected liquidated collateral
    const NEONinSP = (await stabilityPool.getNEON()).toString();
    assert.equal(expectedLiquidatedColl, NEONinSP);
  });
  ...
  it("liquidateTroves(): full redistribution. Compensates the correct amount, and liquidates the remainder", async () => {
    ...
    const ZKUSDinDefaultPool_0 = await defaultPool.getZKUSDDebt();
    ...
    */
    ...
    // Check ZKUSD in DefaultPool has decreased
    const ZKUSDinDefaultPool_1 = await defaultPool.getZKUSDDebt();
    assert.isTrue(ZKUSDinDefaultPool_1.gt(ZKUSDinDefaultPool_0));
    ...
    // Check NEON in defaultPool now equals the expected liquidated collateral
    const NEONinDefaultPool = (await defaultPool.getNEON()).toString();
    assert.isAtMost(
      th.getDifference(expectedLiquidatedColl, NEONinDefaultPool),
      1000
    );
  });
  ...
  it("liquidateTroves(): full offset. Liquidation event emits the correct gas compensation and total liquidated coll and debt", async () => {
    ...
    */
    ...
    // Expect liquidatedDebt = 51 + 190 + 1025 + 13510 = 14646 ZKUSD
  ...
  it("Trove ordering: same collateral, decreasing debt. Price successively increases. Troves should maintain ordering by ICR", async () => {
    ...
    let debt = 50;
    // create 10 troves, constant coll, descending debt 100 to 90 ZKUSD
    for (const account of _10_accounts) {
      const debtString = debt.toString().concat("000000000000000000");
      await openTrove({
        extraZKUSDAmount: debtString,
      ...
      for (account of _10_accounts) {
        ...
        if (ICRList.length > 1) {
          ...
          try {
            ...
            console.log(`NEON price at which trove ordering breaks: ${price}`);
            logICRs(ICRList);
          }
        }
  ...
  it("Trove ordering: increasing collateral, constant debt. Price successively increases. Troves should maintain ordering by ICR", async () => {
    ...
    let coll = 50;
    // create 20 troves, increasing collateral, constant debt = 100ZKUSD
