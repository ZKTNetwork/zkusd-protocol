...
contract("HintHelpers", async (accounts) => {
  ...
  /* Open a Trove for each account. ZKUSD debt is 200 ZKUSD each, with collateral beginning at
  1.5 ether, and rising by 0.01 ether per Trove.  Hence, the ICR of account (i + 1) is always 1% greater than the ICR of account i. 
 */

  // Open Troves in parallel, then withdraw ZKUSD in parallel
  ...
  const withdrawZKUSDfromTrove = async (account) => {
