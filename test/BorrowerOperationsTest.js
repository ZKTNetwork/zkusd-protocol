...
contract("BorrowerOperations", async (accounts) => {
  ...
  const testCorpus = ({ withProxy = false }) => {
    ...
    // skip("addColl(), active Trove: adds the right corrected stake after liquidations have occured", async () => {
    ...
    //     }
    //   );
    //   await borrowerOperations.openTrove(th._100pct, dec(100, 18), bob, bob, {
    //     from: bob,
    //     value: dec(5, "ether"),
    //   });
    //   await borrowerOperations.openTrove(
    ...
    //   );
    //
    //   await borrowerOperations.openTrove(th._100pct, 0, dennis, dennis, {
    //     from: dennis,
    //     value: dec(1, "ether"),
    //   });
    //   // --- TEST ---
    ...
    it("withdrawZKUSD(): decays a non-zero base rate", async () => {
      ...
      await openTrove({
        extraZKUSDAmount: toBN(dec(20, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: A },
      });
      await openTrove({
      ...
      // D withdraws ZKUSD
      await borrowerOperations.withdrawZKUSD(th._100pct, dec(1, 18), A, A, {
        from: D,
      });
    ...
    it("withdrawZKUSD(): reverts if max fee > 100%", async () => {
      await openTrove({
        extraZKUSDAmount: toBN(dec(10, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: A },
      });
      await openTrove({
      ...
      await openTrove({
        extraZKUSDAmount: toBN(dec(40, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: C },
      });
      await openTrove({
      ...
      await assertRevert(
        borrowerOperations.withdrawZKUSD(dec(2, 18), dec(1, 18), A, A, {
          from: A,
        }),
    ...
    it("withdrawZKUSD(): reverts if max fee < 0.5% in Normal mode", async () => {
      ...
      await assertRevert(
        borrowerOperations.withdrawZKUSD(0, dec(1, 18), A, A, { from: A }),
        "Max fee percentage must be between 0.5% and 100%"
      );
      await assertRevert(
        borrowerOperations.withdrawZKUSD(1, dec(1, 18), A, A, { from: A }),
        "Max fee percentage must be between 0.5% and 100%"
      );
      await assertRevert(
        borrowerOperations.withdrawZKUSD("4999999999999999", dec(1, 18), A, A, {
          from: A,
        }),
        "Max fee percentage must be between 0.5% and 100%"
      );
    ...
    it("withdrawZKUSD(): reverts if fee exceeds max fee percentage", async () => {
      await openTrove({
        extraZKUSDAmount: toBN(dec(60, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: A },
      });
      await openTrove({
      ...
      await openTrove({
        extraZKUSDAmount: toBN(dec(70, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: C },
      });
      await openTrove({
        extraZKUSDAmount: toBN(dec(80, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: D },
      });
      await openTrove({
        extraZKUSDAmount: toBN(dec(180, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: E },
      });
      ...
      await assertRevert(
        borrowerOperations.withdrawZKUSD(lessThan5pct, dec(3, 18), A, A, {
          from: A,
        }),
      ...
      await assertRevert(
        borrowerOperations.withdrawZKUSD(dec(1, 16), dec(1, 18), A, A, {
          from: B,
        }),
        "Fee exceeded provided maximum"
      );
      ...
      await assertRevert(
        borrowerOperations.withdrawZKUSD(dec(3754, 13), dec(1, 18), A, A, {
          from: C,
        }),
        "Fee exceeded provided maximum"
      );
      ...
      await assertRevert(
        borrowerOperations.withdrawZKUSD(dec(5, 15), dec(1, 18), A, A, {
          from: D,
        }),
        "Fee exceeded provided maximum"
      );
    ...
    it("withdrawZKUSD(): succeeds when fee is less than max fee percentage", async () => {
      ...
      const tx1 = await borrowerOperations.withdrawZKUSD(
        moreThan5pct,
        dec(1, 18),
        A,
        A,
      ...
      // Attempt with maxFee = 5%
      const tx2 = await borrowerOperations.withdrawZKUSD(
        dec(5, 16),
        dec(1, 18),
        A,
        A,
      ...
      const tx3 = await borrowerOperations.withdrawZKUSD(
        dec(1, 17),
        dec(1, 18),
        A,
        A,
      ...
      const tx4 = await borrowerOperations.withdrawZKUSD(
        dec(37659, 13),
        dec(1, 18),
        A,
        A,
      ...
      const tx5 = await borrowerOperations.withdrawZKUSD(
        dec(1, 18),
        dec(1, 18),
        A,
        A,
    ...
    it("withdrawZKUSD(): doesn't change base rate if it is already zero", async () => {
      ...
      await openTrove({
        extraZKUSDAmount: toBN(dec(30, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: A },
      });
      await openTrove({
      ...
      await openTrove({
        extraZKUSDAmount: toBN(dec(50, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: C },
      });
      await openTrove({
      ...
      // D withdraws ZKUSD
      await borrowerOperations.withdrawZKUSD(th._100pct, dec(37, 18), A, A, {
        from: D,
      });
      ...
      // E opens trove
      await borrowerOperations.withdrawZKUSD(th._100pct, dec(12, 18), A, A, {
        from: E,
      });
    ...
    it("withdrawZKUSD(): lastFeeOpTime doesn't update if less time than decay interval has passed since the last fee operation", async () => {
      ...
      await borrowerOperations.withdrawZKUSD(th._100pct, dec(1, 18), C, C, {
        from: C,
      });
    ...
    it("withdrawZKUSD(): borrowing at non-zero base rate sends ZKUSD fee to ZKT staking contract", async () => {
      ...
      const zktStaking_ZKUSDBalance_Before = await zkusdToken.balanceOf(
        zktStaking.address
      );
      ...
      // D withdraws ZKUSD
      await borrowerOperations.withdrawZKUSD(th._100pct, dec(37, 18), C, C, {
        from: D,
      });

      // Check ZKT ZKUSD balance after has increased
      const zktStaking_ZKUSDBalance_After = await zkusdToken.balanceOf(
        zktStaking.address
      );
      assert.isTrue(
        zktStaking_ZKUSDBalance_After.gt(zktStaking_ZKUSDBalance_Before)
      );
    });
    ...
    if (!withProxy) {
      ...
      it("withdrawZKUSD(): borrowing at non-zero base records the (drawn debt + fee) on the Trove struct", async () => {
        ...
        await zkToken.approve(zktStaking.address, dec(1, 18), {
          from: multisig,
        });
        await zktStaking.stake(dec(1, 18), { from: multisig });
        ...
        const withdrawalTx = await borrowerOperations.withdrawZKUSD(
          th._100pct,
          toBN(dec(37, 18)),
          D,
          D,
        ...
        const emittedFee = toBN(
          th.getZKUSDFeeFromZKUSDBorrowingEvent(withdrawalTx)
        );
    ...
    it("withdrawZKUSD(): Borrowing at non-zero base rate sends requested amount to the user", async () => {
      ...
      await borrowerOperations.withdrawZKUSD(th._100pct, D_ZKUSDRequest, D, D, {
        from: D,
      });
      ...
      assert.isTrue(
        D_ZKUSDBalanceAfter.eq(D_ZKUSDBalanceBefore.add(D_ZKUSDRequest))
      );
    });
    ...
    it("withdrawZKUSD(): Borrowing at zero base rate changes ZKUSD fees-per-unit-staked", async () => {
      ...
      // D withdraws ZKUSD
      await borrowerOperations.withdrawZKUSD(th._100pct, dec(37, 18), D, D, {
        from: D,
      });
    ...
    it("withdrawZKUSD(): reverts when calling address does not have active trove", async () => {
      ...
      const txBob = await borrowerOperations.withdrawZKUSD(
        th._100pct,
        dec(100, 18),
        bob,
        bob,
      ...
      try {
        const txCarol = await borrowerOperations.withdrawZKUSD(
          th._100pct,
          dec(100, 18),
          carol,
          carol,
    ...
    it("withdrawZKUSD(): reverts when requested withdrawal amount is zero ZKUSD", async () => {
      ...
      try {
        const txAlice = await borrowerOperations.withdrawZKUSD(
          th._100pct,
          0,
          alice,
          alice,
    ...
    it("withdrawZKUSD(): reverts if system is in Recovery Mode", async () => {
      ...
      try {
        const txData = await borrowerOperations.withdrawZKUSD(
          th._100pct,
          "200",
          alice,
          alice,
    ...
    it("repayZKUSD(): reverts when repayment would leave trove with ICR < MCR", async () => {
      ...
      await assertRevert(
        borrowerOperations.repayZKUSD(ZKUSDRepayment, alice, alice, {
          from: alice,
        }),
        "BorrowerOps: An operation that would result in ICR < MCR is not permitted"
      );
    ...
    it("repayZKUSD(): Succeeds when it would leave trove with net debt >= minimum net debt", async () => {
      ...
      const repayTxA = await borrowerOperations.repayZKUSD(1, A, A, {
        from: A,
      });
      ...
      const repayTxB = await borrowerOperations.repayZKUSD(dec(19, 25), B, B, {
        from: B,
      });
    ...
    it("repayZKUSD(): reverts when it would leave trove with net debt < minimum net debt", async () => {
      ...
      const repayTxAPromise = borrowerOperations.repayZKUSD(2, A, A, {
        from: A,
      });
      await assertRevert(
        repayTxAPromise,
    ...
    it("repayZKUSD(): reverts when calling address does not have active trove", async () => {
      ...
      const txBob = await borrowerOperations.repayZKUSD(dec(10, 18), bob, bob, {
        from: bob,
      });
      assert.isTrue(txBob.receipt.status);
      ...
      try {
        const txCarol = await borrowerOperations.repayZKUSD(
          dec(10, 18),
          carol,
          carol,
          { from: carol }
    ...
    it("repayZKUSD(): reverts when attempted repayment is > the debt of the trove", async () => {
      ...
      try {
        const txAlice = await borrowerOperations.repayZKUSD(
    ...
    it("repayZKUSD(): reduces the Trove's ZKUSD debt by the correct amount", async () => {
      ...
      await borrowerOperations.repayZKUSD(
    ...
    it("repayZKUSD(): can repay debt in Recovery Mode", async () => {
      ...
      const tx = await borrowerOperations.repayZKUSD(
        aliceDebtBefore.div(toBN(10)),
        alice,
        alice,
        { from: alice }
    ...
    it("repayZKUSD(): Reverts if borrower has insufficient ZKUSD balance to cover his debt repayment", async () => {
      ...
      const repayZKUSDPromise_B = borrowerOperations.repayZKUSD(
        toBN(dec(6, 18)),
        B,
        B,
        { from: B }
      ...
      await assertRevert(
        repayZKUSDPromise_B,
        "Caller doesnt have enough ZKUSD to make repayment"
      );
    });
    ...
    it("adjustTrove(): borrowing at non-zero base rate sends ZKUSD fee to ZKT staking contract", async () => {
      ...
      // D adjusts trove
      await openTrove({
        extraZKUSDAmount: toBN(dec(37, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: D },
      });
    ...
    if (!withProxy) {
      ...
      it("adjustTrove(): borrowing at non-zero base records the (drawn debt + fee) on the Trove struct", async () => {
        ...
        const emittedFee = toBN(
          th.getZKUSDFeeFromZKUSDBorrowingEvent(adjustmentTx)
        );
        assert.isTrue(emittedFee.gt(toBN("0")));
    ...
    it("adjustTrove(): Borrowing at non-zero base rate sends requested amount to the user", async () => {
      ...
      const D_ZKUSDBalanceAfter = await zkusdToken.balanceOf(D);
      assert.isTrue(
        D_ZKUSDBalanceAfter.eq(D_ZKUSDBalanceBefore.add(ZKUSDRequest_D))
      );
    });
    ...
    it("adjustTrove(): debt increase in Recovery Mode charges no fee", async () => {
      ...
      await openTrove({
        extraZKUSDAmount: toBN(dec(200000, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: bob },
      });
      ...
      const zktStakingZKUSDBalanceBefore = await zkusdToken.balanceOf(
        zktStaking.address
      );
      ...
      const zktStakingZKUSDBalanceAfter = await zkusdToken.balanceOf(
        zktStaking.address
      );
      assert.equal(
        zktStakingZKUSDBalanceAfter.toString(),
        zktStakingZKUSDBalanceBefore.toString()
      );
    });
    ...
    it("adjustTrove(): reverts when ZKUSD repaid is > debt of the trove", async () => {
      ...
      const bobFee = toBN(
        await th.getEventArgByIndex(bobOpenTx, "ZKUSDBorrowingFeePaid", 1)
      );
    ...
    it("adjustTrove(): changes ZKUSDToken balance by the requested decrease", async () => {
      ...
      assert.isTrue(
        alice_ZKUSDTokenBalance_After.eq(
          alice_ZKUSDTokenBalance_Before.sub(toBN(dec(10, 18)))
        )
      );
    });
    ...
    it("adjustTrove(): changes ZKUSDToken balance by the requested increase", async () => {
      ...
      assert.isTrue(
        alice_ZKUSDTokenBalance_After.eq(
          alice_ZKUSDTokenBalance_Before.add(toBN(dec(100, 18)))
        )
      );
    });
    ...
    it("adjustTrove(): Changes the ZKUSD debt in ActivePool by requested decrease", async () => {
      ...
      assert.isTrue(
        activePool_ZKUSDDebt_After.eq(
          activePool_ZKUSDDebt_Before.sub(toBN(dec(30, 18)))
        )
      );
    });
    ...
    it("adjustTrove(): Changes the ZKUSD debt in ActivePool by requested increase", async () => {
      ...
      th.assertIsApproximatelyEqual(
        activePool_ZKUSDDebt_After,
        activePool_ZKUSDDebt_Before.add(toBN(dec(100, 18)))
      );
    });
    ...
    it("adjustTrove(): Reverts if borrower has insufficient ZKUSD balance to cover his debt repayment", async () => {
      ...
      const repayZKUSDPromise_B = borrowerOperations.adjustTrove(
        th._100pct,
        0,
        bobDebt,
        false,
    ...
    it("closeTrove(): reduces a Trove's collateral to zero", async () => {
      ...
      // To compensate borrowing fees
      await zkusdToken.transfer(alice, dennisZKUSD.div(toBN(2)), {
        from: dennis,
      });
    ...
    it("closeTrove(): subtracts the debt of the closed Trove from the Borrower's ZKUSDToken balance", async () => {
      ...
      th.assertIsApproximatelyEqual(
        alice_ZKUSDBalance_After,
        alice_ZKUSDBalance_Before.sub(aliceDebt.sub(ZKUSD_GAS_COMPENSATION))
      );
    });
    ...
    it("closeTrove(): applies pending rewards", async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          defaultPool_ZKUSDDebt_afterAliceCloses,
          defaultPool_ZKUSDDebt.sub(pendingDebtReward_A)
        ),
        1000
      );
      ...
      assert.isAtMost(
        th.getDifference(defaultPool_ZKUSDDebt_afterBobCloses, 0),
        100000
      );
    });
    ...
    it("openTrove(): decays a non-zero base rate", async () => {
      ...
      // E opens trove
      await openTrove({
        extraZKUSDAmount: toBN(dec(12, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: E },
      });
    ...
    it("openTrove(): lastFeeOpTime doesn't update if less time than decay interval has passed since the last fee operation", async () => {
      ...
      await openTrove({
        extraZKUSDAmount: toBN(dec(1, 18)),
        ICR: toBN(dec(2, 18)),
        extraParams: { from: D },
      });
    ...
    if (!withProxy) {
      ...
      it("openTrove(): borrowing at non-zero base records the (drawn debt + fee  + liq. reserve) on the Trove struct", async () => {
        ...
        const emittedFee = toBN(
          th.getZKUSDFeeFromZKUSDBorrowingEvent(openTroveTx)
        );
        ...
        th.assertIsApproximatelyEqual(
          newDebt,
          D_ZKUSDRequest.add(emittedFee).add(ZKUSD_GAS_COMPENSATION),
          100000
        );
      });
    }
    ...
    it("openTrove(): Borrowing at non-zero base rate sends requested amount to the user", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, ZKUSDRequest_D, D, D, {
        from: D,
        value: dec(500, "ether"),
      });
    ...
    it("openTrove(): Borrowing at zero base rate charges minimum fee", async () => {
      ...
      const _ZKUSDFee = toBN(
        th.getEventArgByName(txC, "ZKUSDBorrowingFeePaid", "_ZKUSDFee")
      );

      const expectedFee = BORROWING_FEE_FLOOR.mul(toBN(ZKUSDRequest)).div(
        toBN(dec(1, 18))
      );
    ...
    it("openTrove(): creates a new Trove and assigns the correct collateral and debt amount", async () => {
      ...
      const expectedDebt = ZKUSDRequest.add(
        await troveManager.getBorrowingFee(ZKUSDRequest)
    ...
    it("getCompositeDebt(): returns debt + gas comp", async () => {
      ...
      th.assertIsApproximatelyEqual(
        res2,
        ZKUSD_GAS_COMPENSATION.add(toBN(dec(90, 18)))
      );
      ...
      th.assertIsApproximatelyEqual(
        res3,
        ZKUSD_GAS_COMPENSATION.add(toBN(dec(24423422357345049, 12)))
      );
    });
    ...
    if (!withProxy) {
      it("closeTrove(): fails if owner cannot receive ETH", async () => {
        ...
        await zkusdToken.transfer(nonPayable.address, dec(10000, 18), {
          from: alice,
        });
